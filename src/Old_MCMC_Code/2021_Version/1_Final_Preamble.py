...
import time
import datetime
os.chdir("/Users/elizaharris/Dropbox/for work_old-rawdata/201811_N2O-Modelling/mymodel_python/")
...
N2O_fluxes = pd.read_csv("input_data/N2O_ChrisDorich/globaln2o_sites_filled.csv")
