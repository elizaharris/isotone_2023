...
fullmod_prior = model(x=params_orig[:,0],fullres="Y")

# check changes due to a single factor... eege. temp sens
#post_test = post.copy(); post_test[4] = 1
#fullmod_test = model(post_test,fullres="Y")
#anthrop2020_test = fullmod_test[5][220,1]-fullmod_test[5][0,1]
#anthrop2020_post = fullmod_post[5][220,1]-fullmod_post[5][0,1]
